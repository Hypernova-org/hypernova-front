...
export default function Home() {
  return (
    <div className="home">
      <div className="lg:pt-24 xs:pt-4 flex flex-col">
        <div className="grid lg:grid-cols-main xs:grid-cols-1 2xl:flex 2xl:flex-row 2xl:w-full 2xl:justify-between ">
          ...
          >
            <p className="hero-text xl:max-w-[530px] md:max-w-[450px] lg:text-[25px] xs:w-[75%] lg:w-full xs:text-[16px] spacing-[48px] text-[#EBD9FC] font-medium md:mx-auto xs:mx-auto">
              Discover Innovation{" "}
        ...
        <Link href="#about">
          <svg
            className="mx-auto xs:hidden lg:block scroll opacity-40 relative bottom-[18vw] "
            xmlns="http://www.w3.org/2000/svg"
            width="80"
            height="80"
            viewBox="0 0 80 80"
